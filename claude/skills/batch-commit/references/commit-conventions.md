...
Single source of truth for **commit messages and PR title/body** across sessions. `/batch-commit`
(incl. `--pr`) and `/cx-handoff` follow this. A repo's own committed rule (CONTRIBUTING, a
