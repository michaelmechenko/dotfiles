...
hs.hotkey.bind({ "cmd", "ctrl", "alt", "shift" }, "b", borders.toggle)
...
hs.hotkey.bind({ "cmd", "ctrl", "alt" }, "m", window.toggleHideFrontmost)
hs.hotkey.bind({ "cmd", "ctrl", "alt", "shift" }, "g", gaming.toggleGamingMode)
