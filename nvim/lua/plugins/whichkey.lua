...
return {
  ...
  config = function()
    ...
    wk.add({
      ...
      { "<leader>me", desc = "menu" },
      { "<leader>1", "<cmd>LualineBuffersJump! 1<CR>", desc = "buf 1" },
      { "<leader>2", "<cmd>LualineBuffersJump! 2<CR>", desc = "buf 2" },
      { "<leader>3", "<cmd>LualineBuffersJump! 3<CR>", desc = "buf 3" },
      { "<leader>4", "<cmd>LualineBuffersJump! 4<CR>", desc = "buf 4" },
      { "<leader>5", "<cmd>LualineBuffersJump! 5<CR>", desc = "buf 5" },
      { "<leader>6", "<cmd>LualineBuffersJump! 6<CR>", desc = "buf 6" },
      { "<leader>7", "<cmd>LualineBuffersJump! 7<CR>", desc = "buf 7" },
      { "<leader>mc", desc = "prev" },
      { "<leader>mv", desc = "next" },
