/**
 * Shared box-drawing render helpers, mirroring skill-toggle/src/ui/render.ts so
 * both toggle UIs share the same framed, two-pane look. Kept as a local copy
 * (not a cross-extension import) so each extension stays self-contained.
 */
