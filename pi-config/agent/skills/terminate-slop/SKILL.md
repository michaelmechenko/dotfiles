...
description: >
  ...
  post, email, blog, anything between. Use when the user says "terminate slop",
  "de-slop this", "kill the slop", "remove the AI tells", "humanize this",
  "make this not sound like AI", or invokes /skill:terminate-slop. Also use
