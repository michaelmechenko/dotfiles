...
#   performance -> ~/.config/sketchybarrc.performance            (date + battery only, blur=0)
#
...
# flag suppresses both workspace- and focus-change callbacks in aerospace.toml, so performance
# mode incurs no AeroSpace-to-SketchyBar IPC.
#
